var widgetApp = angular.module('widgetApp', ['ui.router']);

widgetApp.config(function($stateProvider, $urlRouterProvider) {
     ...
     ////////////////////////////////////////////////////////////   
        .state('homepage.details', {
            ...
            views: {
                ...
                'columnTwo@homepage': { 
                    //template: 'Widget details',
                    templateUrl: 'widget-details.html',
                    //controller: 'detailsController'
                }
            }
        })
     ////////////////////////////////////////////////////////////   
        .state('homepage.remove', {
            url: '/remove/:widgetID',
...
widgetApp.controller('mainController', ['$scope', '$state', '$stateParams', function($scope, $state, $stateParams) {
    ...
    $scope.setCurWidgetID = function (_curWidgetID, _curNum){
         ...
         $scope.cur_num = parseInt(_curNum);
    };
    ...
    $scope.removeWidget = function (_curNum){
        BootstrapDialog.show({
            ...
            //type: BootstrapDialog.DEFAULT_TEXTS['CONFIRM'],
            title: 'Confirmation',
    ...
    $scope.copy_data = function (){
        $scope.data_backup = Object.assign({}, $scope.widgets[$scope.cur_num]);  // backup widget properties before changing
    };
    ...
    $scope.addWidgetProps = function (){
        event.preventDefault();
        let num = $scope.pairs.length; // Number of new pair
    ...
    $scope.deleteCash = function (){
        $scope.pairs.length = 0; // clear all data from array pairs for future using
...
widgetApp.controller('detailsController', ['$scope', '$state', '$stateParams', function($scope, $state, $stateParams) {
    //$scope.state = $state.current;
    //$scope.params = $stateParams; 
    console.log($state.current);
    console.log("$scope.cur_num:", $scope.cur_num);
    console.log("$cur_widgetID:", $scope.cur_widgetID);
